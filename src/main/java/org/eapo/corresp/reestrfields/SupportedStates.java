 ...
 */
public class SupportedStates extends AbstractElementCreator {

    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(SupportedStates.class);
    ...
    public Element createElement(Element inElement) throws Exception {
        ...
        if (null == nameElement) {
            nameElement = "supportedstates";
        }
        Element element = document.createElement(nameElement);

        List<Map<String, Object>> list = getSupportedStates();
        ...
        while (iter.hasNext()) {
            ...
            Element elementRenew = document.createElement("support");
    ...
    public List<Map<String, Object>> getSupportedStates() throws SQLException {
        ...
        String query = " select b.idmember, b.idcountry, b.nmstate, b.gennmstate,  "
                ...
                + " and a.yearmaintenance = (select max(yearmaintenance) from lapsed where idappli = :idappli and idmember =b.idmember)) as support"
